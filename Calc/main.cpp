...
void NumberIPnetOrHost(DWORD mask, BOOL host, char* output, size_t outputSize)
{
	...
	if (host)
	{
		...
		{   // дл€ остальных случаев: (2^zeroBits - 2)
...
//		{" оличество IP-aдресов в этой сети: ", ""},
//		{" оличество узлов текущей сети: ", ""}
//	};
//	
